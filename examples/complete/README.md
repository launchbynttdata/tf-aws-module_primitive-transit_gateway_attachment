...
| <a name="module_transit_gateway"></a> [transit\_gateway](#module\_transit\_gateway) | git::https://github.com/launchbynttdata/tf-aws-module_primitive-transit_gateway.git | 1.0.0 |
